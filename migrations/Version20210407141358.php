 ...
 */
final class Version20210407141358 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE topic ADD user_id INT NOT NULL, ADD yes VARCHAR(255) NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE topic DROP user_id, DROP yes');
    }
}
